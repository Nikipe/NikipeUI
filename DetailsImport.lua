...
--handling Details Import
function NUI:SetDetailsProfile()
    _detalhes_global = {
        ["npcid_pool"] = {
                ...
                ["instances"] = {
                    {
                        ...
                        ["row_info"] = {
                            ...
                            ["font_face_file"] = "Interface\\AddOns\\ElvUI_AdditionalFonts\\Fonts\\Gotham Narrow Ultra\\Gotham Narrow Ultra.otf",
                            ["backdrop"] = {
                                ["enabled"] = false,
